...
export const populateInitialData = async () => {
  ...
  logger.info('Cleared previous database collections.');
    ...
    // 6. 30+ Realistic Curated Football Jerseys matching Reference Design
    const rawJerseys = [
      {
        ...
        isBestSeller: true,
        colors: ['Blue', 'Navy'],
        tags: ['Atlético Madrid', 'Griezmann', 'La Liga', 'Third Kit', 'Player Version'],
        frontImg: 'https://images.unsplash.com/photo-1574629810360-7efbbe195018?auto=format&fit=crop&w=600&q=90',
        backImg: 'https://images.unsplash.com/photo-1518091043644-c1d4457512c6?auto=format&fit=crop&w=600&q=90',
        description: 'Official Atlético Madrid 24/25 Third Kit Player Issue edition with Riyadh Air branding and aerodynamic Dri-FIT ADV mesh ventilation.',
      },
      {
        ...
        isBestSeller: true,
        colors: ['Gold', 'Black'],
        tags: ['Barcelona', 'Lamine Yamal', 'Custom', 'Away', 'La Liga'],
        frontImg: 'https://images.unsplash.com/photo-1508098682722-e99c43a406b2?auto=format&fit=crop&w=600&q=90',
        backImg: 'https://images.unsplash.com/photo-1579952363873-27f3bade9f55?auto=format&fit=crop&w=600&q=90',
        description: 'Customizable FC Barcelona 25/26 Away Gold Kit with official UNHCR ACNUR sponsor and custom name/number heat-press capability.',
      },
      {
        ...
        isBestSeller: true,
        colors: ['Blue', 'Maroon'],
        tags: ['Barcelona', 'Blaugrana', 'Lewandowski', 'Custom', 'Home Kit'],
        frontImg: 'https://images.unsplash.com/photo-1518091043644-c1d4457512c6?auto=format&fit=crop&w=600&q=90',
        backImg: 'https://images.unsplash.com/photo-1508098682722-e99c43a406b2?auto=format&fit=crop&w=600&q=90',
        description: 'Classic vertical Blaugrana 125th anniversary heritage jersey with gold Spotify sponsor and breathable moisture management.',
      },
      {
        ...
        tags: ['Barcelona', 'Barca Foundation', 'Custom', 'Away'],
        frontImg: 'https://images.unsplash.com/photo-1579952363873-27f3bade9f55?auto=format&fit=crop&w=600&q=90',
        backImg: 'https://images.unsplash.com/photo-1574629810360-7efbbe195018?auto=format&fit=crop&w=600&q=90',
        description: 'Limited edition Black & Purple Catalan typography jersey featuring Barca Foundation branding on the lower back.',
      },
      {
        ...
        isFeatured: true,
        isBestSeller: true,
        colors: ['Grey', 'Metallic Silver'],
        tags: ['Real Madrid', 'Mbappé', 'Bellingham', 'Away Kit', 'Player Version'],
        frontImg: 'https://images.unsplash.com/photo-1522778119026-d647f0596c20?auto=format&fit=crop&w=600&q=90',
        backImg: 'https://images.unsplash.com/photo-1517466787929-bc90951d0974?auto=format&fit=crop&w=600&q=90',
        description: 'Pro player issue slate grey kit with metallic silver trims, HEAT.RDY cooling fabric, and silicone heat-transfer club crest.',
      },
      {
        ...
        isFeatured: true,
        colors: ['White', 'Black'],
        tags: ['Real Madrid', 'Vinicius', 'Custom', 'Home Kit'],
        frontImg: 'https://images.unsplash.com/photo-1517466787929-bc90951d0974?auto=format&fit=crop&w=600&q=90',
        backImg: 'https://images.unsplash.com/photo-1522778119026-d647f0596c20?auto=format&fit=crop&w=600&q=90',
        description: 'Pristine royal white jersey with subtle houndstooth watermark weave and customizable player name and squad number on back.',
      },
      {
        ...
        isNewArrival: true,
        colors: ['Red', 'White'],
        tags: ['Arsenal', 'Saka', 'Odegaard', 'Premier League', 'Custom'],
        frontImg: 'https://images.unsplash.com/photo-1511886929837-354d827aae26?auto=format&fit=crop&w=600&q=90',
        backImg: 'https://images.unsplash.com/photo-1574629810360-7efbbe195018?auto=format&fit=crop&w=600&q=90',
        description: 'Iconic cannon crest on tailored red and white canvas with navy side stripe highlights and AEROREADY performance moisture control.',
      },
      {
        ...
        tags: ['Man City', 'Haaland', 'De Bruyne', 'Premier League', 'Custom'],
        frontImg: 'https://images.unsplash.com/photo-1518091043644-c1d4457512c6?auto=format&fit=crop&w=600&q=90',
        backImg: 'https://images.unsplash.com/photo-1508098682722-e99c43a406b2?auto=format&fit=crop&w=600&q=90',
        description: 'Sky blue home jersey featuring graffiti-inspired 0161 collar and cuff motifs honoring Manchester heritage.',
      },
      {
      ...
      {
        name: 'GOALZA 2026 Cyberpunk Signature Custom',
        team: 'Custom Teams',
        country: 'International',
        league: 'GOALZA Exclusive',
        season: '2026',
        type: 'Custom Jersey',
        price: 4499,
        discountPrice: 3899,
        ...
        tags: ['Custom', 'Cyberpunk', 'GOALZA', 'Exclusive'],
        frontImg: 'https://images.unsplash.com/photo-1540747913346-19e32dc3e97e?auto=format&fit=crop&w=800&q=80',
        backImg: 'https://images.unsplash.com/photo-1518609878373-06d740f60d8b?auto=format&fit=crop&w=800&q=80',
