  ...
  return (
    <div className="bg-white text-black min-h-screen">
      ...
      <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 pt-4">
          {storeGallery.map((item, idx) => (
            <div
              key={idx}
              className={`aspect-square overflow-hidden bg-gray-100 border border-gray-200 shadow-md ${item.rotation} hover:rotate-0 transition-transform duration-300`}
            >
              <img
                src={item.image}
                alt={`Jersey World Archive ${idx + 1}`}
      ...
      <section className="py-20 bg-white max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        {/* Value 3: GLOBAL FOOTBALL COMMUNITY */}
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
          <div className="md:col-span-6 space-y-4">
            <h3 className="text-xl sm:text-2xl font-black font-display uppercase tracking-tight text-black">
