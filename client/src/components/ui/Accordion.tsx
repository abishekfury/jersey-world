          ...
          <div key={item.id} className="py-4">
            ...
            >
              <span
                className={
                  titleClassName ||
                  'text-base sm:text-lg font-semibold text-[#171C1B] group-hover:text-[#FF5722] transition-colors font-sans'
                }
              >
                {item.title}
              </span>
              {iconVariant === 'plus' ? (
                <div className="w-7 h-7 flex items-center justify-center text-neutral-800 group-hover:text-[#FF5722] transition-colors flex-shrink-0 ml-4">
                  {isOpen ? (
